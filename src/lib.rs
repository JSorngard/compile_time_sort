...
const_sort_t!(const_sort_usize, qsort_usize, usize);
const_sort_t!(const_sort_isize, qsort_isize, isize);
const_sort_t!(const_sort_u8, qsort_u8, u8);
const_sort_t!(const_sort_i8, qsort_i8, i8);
const_sort_t!(const_sort_u16, qsort_u16, u16);
const_sort_t!(const_sort_i16, qsort_i16, i16);
const_sort_t!(const_sort_u32, qsort_u32, u32);
const_sort_t!(const_sort_i32, qsort_i32, i32);
const_sort_t!(const_sort_u64, qsort_u64, u64);
const_sort_t!(const_sort_i64, qsort_i64, i64);
